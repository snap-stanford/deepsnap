...
class TestGraph(unittest.TestCase):
    ...
    def test_add_feature_nx(self):
        ...
        self.assertEqual(G.graph.get("graph_feature").
                         eq(graph_x).sum().item(), 2)
        self.assertEqual(G.graph.get("graph_label").
                         eq(graph_y).sum().item(), 1)
    ...
    def test_graph_basics(self):
        ...
        for item in ['G', 'node_feature', 'node_label', 'edge_feature',
    ...
    def test_graph_property_general(self):
        ...
        dg = Graph(G)
        self.assertEqual(dg.keys,
                         ['G', 'node_feature', 'node_label', 'edge_feature',
                          'edge_label', 'graph_feature', 'graph_label',
