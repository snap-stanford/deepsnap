...
class TestBatch(unittest.TestCase):
    ...
    def test_collate_batch_nested(self):
        ...
        for i, size in enumerate(G_sizes):
            ...
            G.node_property = {'node_prop0': torch.ones(size, dims[0]) * i,
    ...
    def test_unbatch_nested(self):
        ...
        self.assertEqual(
            G_list_recon[0].node_property['node_prop0'].size(0), 10)
        self.assertEqual(
            G_list_recon[0].node_property['node_prop0'].size(1), 2)
        self.assertEqual(
            G_list_recon[1].node_property['node_prop1'].size(0), 5)
        self.assertEqual(
